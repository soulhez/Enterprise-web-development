...
<div id="container">
  ...
  <div id="body">
    <section id="content">
      ...
      <div id="login"></div>
      <div id="login_form">
        <form method="post" action="/spate141_A1/LoginServlet">
          <table id="mytable">
            <tr>
            
              <td width="58%"><p><img src="images/added.png" alt="Mountain View" style="width:663px%;height:180px;"></center></p></td>
            </tr>
            <tr>
              <td><p><center><a href="customer_portal.jsp"><b>Click here to Login...</b></a>
             </center></p></td>
            </tr>
          </table>
        </form>
