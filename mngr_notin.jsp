...
<div id="container">
  ...
  <div id="body">
    <section id="content">
      <p>&nbsp;</p>
      <div id="login"><strong>Store Manager Portal</strong> </div>
      <div id="login_form">
        <form action="StrmngrLogin" method="post">
          <table id="mytable">
            <tr>
            ...
            <tr>
              <td colspan="2"><h5 align="center">&nbsp;</h5>
              <h5 align="center">* * Whoa..!! You forget your own ID or PASSWORD?? Contact website administrator :)</h5></td>
            </tr>
            <tr>
