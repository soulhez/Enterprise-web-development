...
<div id="container">
  ...
  <div id="body">
	...
	<table id='mytable'>
      ...
      <%if(cursor.count() == 0){%>
	  <center><h2>"There are no order for this user!"</h2><center>
	  <%}else
	  {
				String ctotal = "";
				String cname = "";
	  ...
	  <%while (cursor.hasNext()) {
		BasicDBObject obj = (BasicDBObject) cursor.next();
					...
					fiveDaysAgo = obj.getString("fiveDaysAgo");
					orderDate = obj.getString("orderDate");
					cItemName = obj.getString("cItemName");
	  %>	
				<table cellspacing='4' style='font-size:14px; outline: thin solid black;'>
		<tbody>
					            <tr style="outline: thin solid black;">
					              <th width='15%'>User </th>
					              <th width='65%' colspan=2><%=cname%></td>
								...
								<tr style="outline: thin dotted black;">
									<td colspan=2>									
									<center><h3>You can cancle this order before: <%=fiveDaysAgo%></h3></center>
									</td>
									
									<td width='20%'>  <form class = '' method = 'get' action = '<%=checkoutURL%>'><input type='hidden' name='orderNum' value=<%=orderNum%>><small><input type='submit' class='formbutton' value='Cancle Order'></small></form>  </td>
