...
<% 
		...
		String pdsc = "" + request.getParameter("pdsc");
			      ...
			      <div id='login_form'>
			          ...
			          <table id='mytable'>
			            <tr>
			              ...
			              <td width='58%'><p><img src='images/submitted1.png' alt='Mountain View' style='width:663px%;height:180px;'></center></p></td>
			            </tr>
			            <tr>
			              <td><p><center>
			
			<h3>Go back to manager portal to ADD, UPDATE or DELETE Product</h3>
