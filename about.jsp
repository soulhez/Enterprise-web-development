...
<div id="container">
  ...
  <nav>
    <ul>
      ...
      <li class="start selected"><a href="about.jsp">About us</a></li>
  ...
  <div id="image_slider"> <img src="images/about-us.jpg" alt="Mountain View" style="width:100%;height:280px;"> </div>
  <div id="body">
    <section id="content">
      <article>
        <center>
      ...
      <center>
        <h3>Assignment 1</h3>
        <h4>Created by: Snehal Patel</h4>
        <h5>Email: spate141@hawk.iit.edu</h5>
        <p>Website designed using HTML, CSS & Servlet to buy various gaming consoles, games & a</p>
   </center>
      </article>
    </section>
    <aside class="sidebar">
