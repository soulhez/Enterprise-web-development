...
<div id="container">
  ...
  <div id="body">
    <section id="content">
      ...
      <div id="login_form">
        <form action="StrmngrLogin.jsp" method="post">
          <table id="mytable">
            <tr>
    ...
    <aside class="sidebar">
      <ul>
        ...
        <li>
          <h4>Game Consoles</h4>
          <ul>
            <li><a href="ActivisionPage">Electronic Arts</a></li>
            <li><a href="EaPage">Activision</a></li>
            <li><a href="TaketwoPage">Take Two</a></li>
          </ul>
        </li>
        <li>
          <h4>Games Vendor</h4>
