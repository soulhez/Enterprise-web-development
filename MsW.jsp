...
<title>Microsoft XBox Warranty</title>
...
<div id="container">
  ...
  <div id="image_slider"> <img src="images/Microsoft XBox Warranty.jpg" alt="Mountain View" style="width:100%;height:280px;"> </div>
  <div id="body">
    <section id="content">
      <article class="expanded">
        <center>
          <h3><u>Microsoft XBox Warranty</u></h3>
        </center>
        <p>&nbsp;</p>
<hr>
        ...
        <table cellspacing="15">
          <tbody><tr>
            <td><img src="images/w_1.jpg" width="160" height="190" alt="X Box"></td>
            <td><b>Microsoft Complete: 1 Year Warranty</b>
              <ui>
                <li>$199.99</li>
                ...
                <input class="submit-button" type="HIDDEN" name="itemID" value="w_1">
              ...
              <form class="submit-button" method="get" action="AddReviews.jsp">
                <input class="submit-button" type="HIDDEN" name="productName" value="w_1">
