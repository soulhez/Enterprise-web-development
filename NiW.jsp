...
<title>Nintendo WII &amp; WII U Warranty</title>
...
<div id="container">
  ...
  <div id="image_slider"> <img src="images/Nintendo WII &amp; WII U Warranty.jpg" alt="Mountain View" style="width:100%;height:280px;"> </div>
  <div id="body">
    <section id="content">
      <article class="expanded">
        <center>
          <h3><u>Nintendo WII &amp; WII U Warranty</u></h3>
        </center>
        <p>&nbsp;</p>
<hr>
        ...
        <table cellspacing="15">
          <tbody><tr>
            <td><img src="images/w_3.jpg" width="160" height="190" alt="X Box"></td>
            <td><b>Nintendo warranty: 1 Year Warranty</b>
              <ui>
                <li>$199.99</li>
                ...
                <input class="submit-button" type="HIDDEN" name="itemID" value="w_3">
              ...
              <form class="submit-button" method="get" action="AddReviews.jsp">
                <input class="submit-button" type="HIDDEN" name="productName" value="w_3">
                <input class="submit-button" type="HIDDEN" name="itemCost" value="199.99">
